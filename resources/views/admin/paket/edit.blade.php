<form action="{{ route('admin.paket.update', $paket->id) }}" class="modal-form" method="POST">
    @csrf
    @method('PUT')
    ...
    <div class="modal-body">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="nama" id="nama" value="{{ $paket->nama }}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" name="diskon" id="diskon" value="{{ $paket->diskon }}">
        </div>
        <div class="mb-3">
            <label class="form-label" for="diskon">Deskripsi</label>
            <textarea class="form-control" name="deskripsi" id="deskripsi" cols="30" rows="10">{{ $paket->deskripsi }}</textarea>
        </div>
    </div>
