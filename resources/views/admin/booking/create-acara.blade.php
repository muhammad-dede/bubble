<form action="{{ route('admin.booking.store.acara') }}" class="modal-form" method="POST">
    @csrf
    @method('post')
    <div class="modal-header">
        <h5 class="modal-title">Buat Acara</h5>
    ...
    <div class="modal-body">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="tempat_lahir_pengantin_pria"
                id="tempat_lahir_pengantin_pria">
        </div>
        <div class="mb-3">
            ...
            <input type="date" class="form-control" name="tanggal_lahir_pengantin_pria"
                id="tanggal_lahir_pengantin_pria">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="pekerjaan_pengantin_pria"
                id="pekerjaan_pengantin_pria">
        </div>
        <div class="mb-3">
            <label class="form-label" for="instagram_pengantin_pria">Instagram Pengantin Pria (Optional)</label>
            <input type="text" class="form-control" name="instagram_pengantin_pria"
                id="instagram_pengantin_pria">
        </div>
        <hr>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="tempat_lahir_pengantin_wanita"
                id="tempat_lahir_pengantin_wanita">
        </div>
        <div class="mb-3">
            ...
            <input type="date" class="form-control" name="tanggal_lahir_pengantin_wanita"
                id="tanggal_lahir_pengantin_wanita">
        </div>
        <div class="mb-3">
            <label class="form-label required" for="pengantin_wanita_anak_ke">Pengantin Wanita Anak Ke</label>
            <input type="number" class="form-control" name="pengantin_wanita_anak_ke"
                id="pengantin_wanita_anak_ke">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" name="telepon_pengantin_wanita"
                id="telepon_pengantin_wanita">
        </div>
        <div class="mb-3">
